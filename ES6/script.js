...
// let shallowCopy = {...myObj1} 
let shallowCopy = Object.assign({}, myObj1);
...
let deepCopy = JSON.parse(JSON.stringify(myObj2)) //deep copy

console.log("Object before modification myObj2: ", myObj2);
console.log("Object before modification deepCopy: ", deepCopy);

deepCopy.name ="Rahul";
deepCopy.courses[0] = "DSA"
